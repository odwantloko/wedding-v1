    ...
    <div id="gettingThere" className="text-center">
      <div className="container">
        <div className="section-title">
          ...
          <h2>Accommodation</h2>
          <p>Rustenburg offers a wide range of charming guesthouses and accommodation choices that cater to various budgets and personal preferences. To assist you in your search, we've curated a selection of suggestions below. The options are ordered by nearest distance to the venues. Additionally, you also have the option to explore Airbnb listings.</p>
        </div>
